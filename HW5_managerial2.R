...
# for distribution i, there are very small jumps and the acceptance rate is high
# for theta 1 and theta 2.

# now re-do for scale = 10
scale = 10
prop_sigma = (scale)^2*diag(2)
...
# for distribution i, the jumps are very small and the acceptance rate is high
# for distribution ii, the jumps are very large and the acceptance rate is low
